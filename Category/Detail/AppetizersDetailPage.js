...
const AppetizersDetailPage = ({ route, navigation }) => {
  const { appetizers } = route.params;
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.ratingBadge}>
        <Text style={styles.ratingText}>{appetizers.rating} </Text>
        <Image source={require('../../../assets/icons/Star.png')} style={styles.starIcon} />
      </View>

      <ScrollView style={styles.content}>
        <Image source={{ uri: appetizers.image }} style={styles.appetizersImage} />

        <View style={styles.priceRow}>
          <Text style={styles.price}>{appetizers.price}</Text>
...
export default AppetizersDetailPage;
