...
const TopBarTest = () => {
  const navigation = useNavigation(); // ใช้ useNavigation เพื่อเข้าถึงฟังก์ชันการนำทาง

  // ฟังก์ชันที่เรียกเมื่อกดปุ่ม User
  const handleUserPress = () => {
    navigation.navigate('OrderScreen'); // นำทางไปที่หน้า OrderScreen
  };
  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        ...
        <TouchableOpacity style={styles.iconButton} onPress={handleUserPress}> {/* เพิ่ม onPress ที่นี่ */}
